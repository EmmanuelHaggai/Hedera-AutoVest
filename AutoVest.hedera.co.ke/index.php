    ...
    <section class="hero-6-section">
        ...
        <div class="container">
            ...
            <div class="hero-text-wrapper wow animate__animated custom-fadeInUp" data-wow-delay="0.5s">
                ...
                <div class="btn-block">
                    <a href="https://autovest.solyntra.org/demo/" class="btn primary" target="_blank">
                        Watch Demo
                    </a>
                    <a href="https://wa.me/18167908575?text=Hi" target="_blank" rel="noopener noreferrer" class="btn primary">
                        Start on WhatsApp
                    </a>
                </div>
            </div>
    ...
    <section class="services-offer-section padding-bottom">
        <div class="container">
            ...
            <div class="services-card-wrapper grid-3-col">
                ...
                <a href="https://wa.me/18167908575?text=Hi" target="_blank" rel="noopener noreferrer" class="main-services-card wow animate__animated custom-fadeInUp" data-wow-delay="0.1s">
                    <div class="head">
...
(() => {
  // --- Config ---
  const ENDPOINT = "https://whatsapp.solyntra.org/get_nse_snapshot.php?key=readljiou09jlij099pjpojuiiuohiojkhoy89uhiljhp9j";
